...
function getDocDef(inpObj) {
	...
	insertVariableFields(docDefinition, inpObj);

	return docDefinition;
}

function insertVariableFields(docDefinition, inpObj) {
	if (inpObj == undefined) throw new Error('Input obj not provided');
	if (typeof inpObj !== 'object') throw new Error('Input obj must be a object');
	if (inpObj.totalAmount == undefined) throw new Error('Total amount not provided');
	if (inpObj.paidToDate == undefined) throw new Error('Paid to date amount not provided');
	if (inpObj.balance == undefined) throw new Error('Balance amount not provided');
